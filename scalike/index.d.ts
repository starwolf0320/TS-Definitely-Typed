...
declare namespace scalike {
    ...
    export namespace Future {
        ...
        function sequence<A>(fus: Future<A>[]): Future<A[]>;
        function firstCompletedOf<A>(fus: Future<A>[]): Future<A>;
        function find<A>(fus: Future<A>[], f: (a: A) => boolean): Future<Optional<A>>;
        function foldLeft<A, B>(fu: Future<A>[], zero: B, f: (b: B, a: A) => B): Future<B>;
        function reduceLeft<A, B>(fu: Future<A>[], f: (b: B, a: A) => B): Future<B>;
