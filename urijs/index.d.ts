...
declare namespace uri {
    ...
    interface URI {
        ...
        hasQuery(name: string | any, value?: string | number | boolean | Function | string[] | number[] | boolean[] | RegExp, withinArray?: boolean): boolean;
        hasSearch(name: string | any, value?: string | number | boolean | Function | string[] | number[] | boolean[] | RegExp, withinArray?: boolean): boolean;
        subdomain(): string;
