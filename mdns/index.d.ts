...
declare namespace MDNS {
    ...
    interface ServiceType {
        ...
        new(serviceTypeIdentifier: string[]): ServiceType;
        new(serviceTypeIdentifier: {name: string; protocol: string; subtypes?: string[]}): ServiceType;
        ...
        fromJSON(serviceTypeIdentifier: {name: string; protocol: string; subtypes?: string[]}): ServiceType;
    ...
    function makeServiceType(serviceTypeIdentifier: {name: string; protocol: string; subtypes?: string[]}): ServiceType;
