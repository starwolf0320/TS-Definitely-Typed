...
declare namespace ol {
    ...
    class Observable extends ol.events.EventTarget {
         ...
         */
        on(type: string | string[], listener: Function, opt_this?: GlobalObject): ol.events.Key | Array<ol.events.Key>;
         ...
         * @returns Unique key for the listener.
         */
        once(type: string | string[], listener: Function, opt_this?: GlobalObject): ol.events.Key | Array<ol.events.Key>;
