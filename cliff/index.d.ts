...
export function stringifyObjectRows(rows: {}[], keys: string[], colors?: string[]): string;
export function putRows(level: string, rows: string[][], colors?: string[]): void;
export function putObjectRows(level: string, rows: {}[], keys: string[], colors?: string[]): void;
